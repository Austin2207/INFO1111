...
\\[1em]
\\[1em]
Screenshot for command entered and output of compiling from the command line: (each figure includes the output from the previous command entered)
...
\end{figure}
\vspace{-100mm} % Adjust the vertical space here
\begin{figure*}[H]
    \centering
...
\begin{figure*}[H]
    ...
    \caption{Out puf fromt the previous command}
\end{figure}
\vspace{-50cm} % Adjust the vertical space here
